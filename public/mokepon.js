...
let ratigueya = new Mokepon('Ratigueya', './assets/mokepons_mokepon_ratigueya_attack.jpg', 5, './assets/ratigueya.png')
                    ...
                    mokeponesEnemigos = enemigos.map(function (enemigo) {
                        ...
                        if (enemigo.mokepon != undefined) {
                            ...
                            if (mokeponNombre === "Hipodoge") {
                                ...
                                mokeponEnemigo = new Mokepon('Ratigueya', './assets/mokepons_mokepon_ratigueya_attack.jpg', 5, './assets/ratigueya.png', enemigo.id)
                            }
